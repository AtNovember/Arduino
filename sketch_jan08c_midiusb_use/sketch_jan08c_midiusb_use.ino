/* бля будет работать только на arduino zero */
...
const uint8_t buttons[NUM_BUTTONS] = {button1, button2, button3, button4 };
const byte notePitches[NUM_BUTTONS] = {C3, D3, E3, F3};
